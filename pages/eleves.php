...
<html lang="fr">
    <head>
        ...
        <title>Productions des élèves</title>
    ...
    <body>
        ...
        <div class="card-group">
            ...
            <div class="card">
                <img src="./../images/eleves/Anne Primault TS3.jpg" class="card-img-top" alt="...">
            </div>
            <div class="card">
                <img src="./../images/eleves/Annelies Geffroy.jpg" class="card-img-top" alt="...">
            </div>
            <div class="card">
        ...
        <div class="card-group">
            ...
            <div class="card">
                <img src="./../images/eleves/Badra Bouziane.jpg" class="card-img-top" alt="...">
            </div>
            <div class="card">
